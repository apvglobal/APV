...
namespace Apv.SmartContract
{
    public class StateReader : InteropService
    {
        ...
        public StateReader()
        {
            Register("Apv.Runtime.GetTrigger", Runtime_GetTrigger);
            Register("Apv.Runtime.CheckWitness", Runtime_CheckWitness);
            Register("Apv.Runtime.Notify", Runtime_Notify);
            Register("Apv.Runtime.Log", Runtime_Log);
            Register("Apv.Blockchain.GetHeight", Blockchain_GetHeight);
            Register("Apv.Blockchain.GetHeader", Blockchain_GetHeader);
            Register("Apv.Blockchain.GetBlock", Blockchain_GetBlock);
            Register("Apv.Blockchain.GetTransaction", Blockchain_GetTransaction);
            Register("Apv.Blockchain.GetAccount", Blockchain_GetAccount);
            Register("Apv.Blockchain.GetValidators", Blockchain_GetValidators);
            Register("Apv.Blockchain.GetAsset", Blockchain_GetAsset);
            Register("Apv.Blockchain.GetContract", Blockchain_GetContract);
            Register("Apv.Header.GetHash", Header_GetHash);
            Register("Apv.Header.GetVersion", Header_GetVersion);
            Register("Apv.Header.GetPrevHash", Header_GetPrevHash);
            Register("Apv.Header.GetMerkleRoot", Header_GetMerkleRoot);
            Register("Apv.Header.GetTimestamp", Header_GetTimestamp);
            Register("Apv.Header.GetConsensusData", Header_GetConsensusData);
            Register("Apv.Header.GetNextConsensus", Header_GetNextConsensus);
            Register("Apv.Block.GetTransactionCount", Block_GetTransactionCount);
            Register("Apv.Block.GetTransactions", Block_GetTransactions);
            Register("Apv.Block.GetTransaction", Block_GetTransaction);
            Register("Apv.Transaction.GetHash", Transaction_GetHash);
            Register("Apv.Transaction.GetType", Transaction_GetType);
            Register("Apv.Transaction.GetAttributes", Transaction_GetAttributes);
            Register("Apv.Transaction.GetInputs", Transaction_GetInputs);
            Register("Apv.Transaction.GetOutputs", Transaction_GetOutputs);
            Register("Apv.Transaction.GetReferences", Transaction_GetReferences);
            Register("Apv.Attribute.GetUsage", Attribute_GetUsage);
            Register("Apv.Attribute.GetData", Attribute_GetData);
            Register("Apv.Input.GetHash", Input_GetHash);
            Register("Apv.Input.GetIndex", Input_GetIndex);
            Register("Apv.Output.GetAssetId", Output_GetAssetId);
            Register("Apv.Output.GetValue", Output_GetValue);
            Register("Apv.Output.GetScriptHash", Output_GetScriptHash);
            Register("Apv.Account.GetScriptHash", Account_GetScriptHash);
            Register("Apv.Account.GetVotes", Account_GetVotes);
            Register("Apv.Account.GetBalance", Account_GetBalance);
            Register("Apv.Asset.GetAssetId", Asset_GetAssetId);
            Register("Apv.Asset.GetAssetType", Asset_GetAssetType);
            Register("Apv.Asset.GetAmount", Asset_GetAmount);
            Register("Apv.Asset.GetAvailable", Asset_GetAvailable);
            Register("Apv.Asset.GetPrecision", Asset_GetPrecision);
            Register("Apv.Asset.GetOwner", Asset_GetOwner);
            Register("Apv.Asset.GetAdmin", Asset_GetAdmin);
            Register("Apv.Asset.GetIssuer", Asset_GetIssuer);
            Register("Apv.Contract.GetScript", Contract_GetScript);
            Register("Apv.Storage.GetContext", Storage_GetContext);
            Register("Apv.Storage.Get", Storage_Get);
