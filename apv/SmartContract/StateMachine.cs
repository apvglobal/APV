...
namespace Apv.SmartContract
{
    public class StateMachine : StateReader
    {
        ...
        public StateMachine(DataCache<UInt160, AccountState> accounts, DataCache<ECPoint, ValidatorState> validators, DataCache<UInt256, AssetState> assets, DataCache<UInt160, ContractState> contracts, DataCache<StorageKey, StorageItem> storages)
        {
            ...
            Register("Apv.Account.SetVotes", Account_SetVotes);
            Register("Apv.Validator.Register", Validator_Register);
            Register("Apv.Asset.Create", Asset_Create);
            Register("Apv.Asset.Renew", Asset_Renew);
            Register("Apv.Contract.Create", Contract_Create);
            Register("Apv.Contract.Migrate", Contract_Migrate);
            Register("Apv.Contract.GetStorageContext", Contract_GetStorageContext);
            Register("Apv.Contract.Destroy", Contract_Destroy);
            Register("Apv.Storage.Put", Storage_Put);
            Register("Apv.Storage.Delete", Storage_Delete);
